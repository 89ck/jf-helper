...
public abstract class AbstractDbGenerator {
    /**
     * 当前项目名称， 在idea下的module模式下，缺少项目名称会导致生成文件的路径错误，单项目模式下，可以不设置
     */
    ...
    /**
     * 设置当前项目名称， 在idea下的module模式下，缺少项目名称会导致生成文件的路径错误，单项目模式下，可以不设置
     *
     * @param projectName
     */
    ...
    public void generate() {
        ...
        // base model 文件保存路径
        String baseModelOutputDir = System.getProperty("user.dir") + this.projectName + "/src/main/java/"
